...
export function ScheduleLessonCard({
  ...
  const footerMovable =
    variant === "teacher"
      ? "Перетащите на другой слот или нажмите слот ниже. Для преподавателя новое время — любой свободный слот в будущем (без требования «за сутки»), как в кабинете преподавателя."
      : "Перетащите на другой слот или нажмите слот ниже. Для ученика цель — только слоты от 24 ч до 7 суток вперёд."
