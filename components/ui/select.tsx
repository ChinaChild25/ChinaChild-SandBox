...
function SelectContent({
  className,
  children,
  /** item-aligned: ширина с триггером, без «парящего» popper-отступа — ближе к нативному селекту */
  ...
  return (
    <SelectPrimitive.Portal>
      <SelectPrimitive.Content
        ...
        className={cn(
          'relative z-50 max-h-(--radix-select-content-available-height) min-w-[8rem] origin-(--radix-select-content-transform-origin) overflow-x-hidden overflow-y-auto rounded-lg border border-border/70 bg-popover text-popover-foreground shadow-sm',
