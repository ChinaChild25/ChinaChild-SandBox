...
export const mentorsBySlug: Record<string, MentorProfile> = {
  "eo-mi-ran": {
    ...
    curatorIntro:
      "Я помогаю вам не потеряться в расписании и дедлайнах: отвечаю в чате, напоминаю о важном и связываю с преподавателем, если нужна отдельная обратная связь. Уроки и методику ведёт ваш преподаватель — моя зона это сопровождение и организация.",
    curatorFocus: [
